        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>
              <span className="inline-block px-4 py-2 bg-[#00C7B7]/10 text-[#00C7B7] text-sm font-semibold rounded-full mb-6">Tech Marketing</span>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-[#0B1214] leading-tight mb-6">Scale Your <span className="text-[#00C7B7]">Tech Company</span></h1>
              <p className="text-lg text-[#A8B7B5] mb-8">B2B marketing strategies that help technology companies acquire customers, drive adoption, and accelerate growth.</p>
