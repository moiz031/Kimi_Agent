        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>
              <span className="inline-block px-4 py-2 bg-[#12AAD1]/10 text-[#12AAD1] text-sm font-semibold rounded-full mb-6">AI & Automation</span>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-[#0B1214] leading-tight mb-6">Transform With <span className="text-[#12AAD1]">AI</span> Power</h1>
              <p className="text-lg text-[#A3B0B7] mb-8">Leverage artificial intelligence to automate processes, enhance customer experiences, and drive business efficiency.</p>
